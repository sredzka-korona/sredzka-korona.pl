(function () {
  ...
  const GB_MODAL_ASSET_VERSION = "20260411-3";
  /**
  ...
  function renderServiceStep() {
    const serviceKeys = serviceKeysForModalTiles();
    return `
      <section>
        <div class="gb-service-tiles${serviceKeys.length === 2 ? " gb-service-tiles--count-2" : ""}">
